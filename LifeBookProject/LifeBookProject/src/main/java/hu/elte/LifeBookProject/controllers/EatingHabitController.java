...
public class EatingHabitController {
    ...
    public ResponseEntity<Iterable<EatingHabit>> getByIsFood(@PathVariable String eating){
        ...
        if(eating.equals("food")) eatingHabit = eatingHabitRepo.getByIsFood(true);
        else if(eating.equals("drink")) eatingHabit = eatingHabitRepo.getByIsFood(false);
    ...
    public ResponseEntity<EatingHabit> delete(@PathVariable String name){
        ...
        if(eatingHabit == null) return ResponseEntity.notFound().build();
