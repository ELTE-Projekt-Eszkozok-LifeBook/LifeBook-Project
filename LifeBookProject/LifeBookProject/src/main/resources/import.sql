...
INSERT INTO Diary(text, image, video, current_mood, date) VALUES ('My head is aching all day so I am in a really bad mood now.', null, null, 'DEPRESSED', '2020-04-06');
...
INSERT INTO Sport(name, regularity, duration, start_time, is_official) VALUES ('Skiing', 'EVERY YEAR', 20.0, '2010-03-16', FALSE);
...
INSERT INTO Timetable(event, frequency, date, time, note) VALUES ('Birthday Party', 'OCCASIONAL', '2020-03-16', '17:00:00', 'Booked 2 rooms in Escape Room.');
...
INSERT INTO Timetable(event, frequency, date, time, note) VALUES ('Meeting with my friends', 'OCCASIONAL', '2020-08-31', '12:00:00', 'I am looking forward to it :D');
...
INSERT INTO Todo(todo_text, checked, important, category) VALUES ('Buy another bag of dog food!', FALSE, TRUE, 'SHOPPING');